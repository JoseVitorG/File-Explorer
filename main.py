...
favoritos = [{'text': 'C', 'caminho': "C:\\"},
             ...
             {'text': 'Área de trabalho', 'caminho': "C:\\Users\\josev\\OneDrive\\Área de Trabalho\\"}
             ]
...
def enviar_para_github():
    try:
        # Caminho do repositório local (substitua pelo caminho correto do seu repositório)
        caminho_repo = "https://github.com/JoseVitorG/File-Explorer"
